var QualityPerson = {
    ...
    pagerId: "#grid-pager",
    table: null,
    domain: "qualityperson_statistics"
};
...
QualityPerson.search = function () {
    ...
    $.ajax({
        url: "/qualityperson/search?companyId=" + companyId+"&projectId="+projectId+"&month="+time+"&quserid="+quserid,
        type: 'GET',
        dataType: "json",
        success: function (r) {
...
QualityPerson.download = function () {
    ...
    var time = $("#date").val();
    $.ajax({
        url: "/qualityperson/export?companyId=" + companyId+"&projectId="+projectId+"&month="+time+"&quserid="+quserid,
        type: 'GET',
        dataType: "json",
        success : function(data) {
            window.open("/qualityperson/download?key="+data.obj);
        }
    });
