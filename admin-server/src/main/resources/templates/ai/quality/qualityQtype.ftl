                            ...
                            <div class="bar search-bar">
                                <div class="form-inline">
                                    <div class="form-group">
                                        <label>企业：</label>
                                        <input id="projectIdparam" type="hidden" value="${params.projectId}" />
                                        <input id="timeParam" type="hidden" value="${params.time}" />
                                        <select id="companyId" class="form-control" onchange="Quality.changeCompany();" style="width: 150px;">
                                            <#if (companies?size>1)>
                                                <option value="">不限</option>
                                            </#if>
                                            <#list companies as company>
                                                <#if company.id == params.companyId>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="questionType" class="form-control" style="width: 150px;" >
                                            ...
                                            <#list questionTypes as questionType>
                                                <#if questionType.id == params.questionType>
...
<script src="/static/modular/ai/quality/qualityqtype.js"></script>
