            ...
            <div class="wrapper wrapper-content animated fadeIn">
                        ...
                        <div class="row">
                            <div class="ibox collapsed border-bottom">
                                <div class="ibox-content" style="display: block;">
                                    ...
                                    <button class="control-auth btn btn-success" data-auth="leadsquality_recombine" id="recombine" onclick="recombine()" type="button"  controls="controls"  style="margin:10px 10px 5px 15px;vertical-align: middle;">录音重新生成</button>
                                </div>
                                <div class="ibox-content" style="display: block;">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6  control-auth" data-auth="leadsquality_verify">
                            <div class="row">
                                <div class="ibox collapsed border-bottom">
                                    <div class="ibox-title">
                                    ...
                                    <div class="ibox-content" style="display:block;height: 150px;">
                                        <div class="col-lg-5">
                                            <div class="row">
                                                ...
                                                <#--</select>-->
                                                    <#if verify==''>
                                                        <label><input class="label-index" type="radio" value="" name="verify" checked>未审核</label>
                                                        <label><input class="label-index" type="radio" value="1" name="verify">审核合格</label>
                                                        <label><input class="label-index" type="radio" value="0" name="verify">审核不合格</label>
                                                    <#elseif verify=='0'>
                                                        <label><input class="label-index" type="radio" value="" name="verify" >未审核</label>
                                                        <label><input class="label-index" type="radio" value="1" name="verify">审核合格</label>
                                                        <label><input class="label-index" type="radio" value="0" name="verify" checked>审核不合格</label>
                                                    <#else>
                                                        <label><input class="label-index" type="radio" value="" name="verify" >未审核</label>
                                                        <label><input class="label-index" type="radio" value="1" name="verify" checked>审核合格</label>
                                                        <label><input class="label-index" type="radio" value="0" name="verify" >审核不合格</label>
                                                    </#if>
                                            </div>
                                        </div>
                                        <div class="col-lg-5">
                                            <div class="row">
                                                <span ><font style="vertical-align: inherit;">原因：</font></span>
                                                <textarea rows="5" cols="50" class="comments" id="verifydetail" >${verifyreason}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="row" style="margin-left: 0px;margin-top: 80px;">
...
<script type="text/javascript">
    $(document).ready(function(){
        refreshPermission("leads_quality");
    });
    ...
    function recombine(){
        ...
        $.ajax({
            url: "/leadsquality/recombine?phoneId=" + GetQueryString("phoneId"),
            type: 'GET',
            dataType: "json",
            success: function (r) {
                if(r.code ===0){
    ...
    var zhijian = function () {
        window.location.href = "/leadsquality/detailComm?phoneId="+$("#nextPhoneId").val()+"&companyId="+$("#companyId").val()
                +"&phone="+$("#phone").val()+"&projectId="+$("#projectId").val()+
                "&status="+$("#status").val()+"&time="+$("#date").val();
    };
    ...
    $(".submitBtn").click(function(){
        ...
        console.log(values);
        $.ajax({
            url: "/leadsquality/commleads/add",
            type: 'post',
            data:{
                keys: keys,
                values: values,
    ...
    function  submitVerify() {
        var rera= $("input[name='verify']:checked").val();
        $.ajax({
            url: "/leadsquality/subverify",
            type: 'post',
            data:{
                // verstatus:$("#verify").val() ,
                verstatus:rera,
                callId: $("#callid").val(),
                verdetail: $("#verifydetail").val(),
            },
            dataType: "json",
            success: function (r) {
                if (r.code === 0) {
