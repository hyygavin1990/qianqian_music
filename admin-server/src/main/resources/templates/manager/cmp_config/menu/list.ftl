                    ...
                    <div class="ibox ">
                        <div class="ibox-content">
                            ...
                            <div class="bar operate-bar">
                                <button class="btn btn-sm btn-primary" data-auth="cmp_menu_create" onclick="CmpMenu.create()">新增</button>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-primary" onclick="CmpMenu.insert()">确定</button>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="modalTitle" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-primary" onclick="CmpMenu.update()">确定</button>
                <button type="button" class="btn btn-sm btn-default" data-dismiss="modal">关闭</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
...
<script src="/static/modular/manager/cmp_config/menu/menu.js"></script>
